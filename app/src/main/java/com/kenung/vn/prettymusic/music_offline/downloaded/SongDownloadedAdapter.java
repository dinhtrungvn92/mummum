...
public class SongDownloadedAdapter extends RecyclerView.Adapter<SongDownloadedAdapter.DataViewHolder> {

    private ArrayList<Song> songs;
    private Context context;
    public static String type;

    public SongDownloadedAdapter(Context context, ArrayList<Song> songs, String type) {
        this.songs = songs;
    ...
    @Override
    public SongDownloadedAdapter.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public static class DataViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View v) {
            ...
            context.sendBroadcast(new Intent("OnclickSongItemDownloaded"));
