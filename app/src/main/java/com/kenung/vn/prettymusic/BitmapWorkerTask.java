...
public class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
    ...
    public BitmapWorkerTask(Context c, ImageView imageView, int reqWidth, int reqHeight) {
    ...
    public static Bitmap decodeSampledBitmapFromUri(String art_uri, int reqWidth, int reqHeight) {
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(art_uri, options);
        if (bitmap != null) {
            ...
            return ImageHelper.getRoundedCornerBitmap(bitmap, 15);
        }
        return null;
    }
